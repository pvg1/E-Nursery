...
<header>
	...
	<form:form action="/updated/${username}" method="POST" modelAttribute="addService">
	<table>
	 <tr><th> Plant Id:</th>
	    <td><form:input type="number" path="PlantId"  class="form-control"/></td>
	    <td><form:errors path="PlantId"/> </td>
	</tr>
	<tr><th>Plant Name:</th>
	    <td><form:select path="plantname" items="${SerName}"  class="form-control"/></td>
	</tr>
	<tr><th>Plant Type:</th>
	    <td><form:select path="planttype" items="${SerType}"  class="form-control"/></td>
	</tr>
	<tr><th>season</th>
	    <td><form:input type="text" path="season" required="required" class="form-control"/></td>
	    <td><form:errors path="season" cssClass="bg-danger"/> </td>
	</tr>
	<tr><th>Origin:</th>
	    <td><form:input type="text" path="origin" required="required" class="form-control"/></td>
	    <td><form:errors path="origin" cssClass="bg-danger"/> </td>
	</tr>
	<tr><th>Variety:</th>
	    <td><form:input type="text" path="variety" required="required" class="form-control"/></td>
