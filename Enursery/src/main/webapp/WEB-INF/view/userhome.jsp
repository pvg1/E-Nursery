...
<h3>Hello,${username}.</h3>
	...
	<tr>
	<th>Plant Name:</th>
	<td><form:select path="plantname" required="required" class="form-control">
	 <form:option value="all" label="All"/>
	 <form:options items="${searchname}"/>
	</form:select></td>
	<tr>
	<th> Season:</th>
	<td><form:select path="season" required="required" class="form-control">
	<form:option value="all" label="All"/>
	<form:options items="${searchseason}"/>
	</form:select></td>
	</tr>
	...
	<tr><td><a href="/refer" class="btn btn-info link"> Refer    </a></td></tr>

	<tr><td><a href="/help_feedback" class="btn btn-info link"> Help & Feedback    </a></td></tr>
