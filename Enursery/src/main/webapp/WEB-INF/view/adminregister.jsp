<!-- Admin register page by using the link in userregister page -->
...
<body>
	...
	<!-- Admin registration and modelattribute is login -->
	<form:form method="POST" action="/adminregister" modelAttribute="login">
		<table>
			<tr>
				<th colspan=2><h4>Please fill in this form to create an Admin account.</h4><th>
			</tr>
			<tr>
				<th>Name</th>
